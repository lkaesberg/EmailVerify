...
module.exports = {
    data: new SlashCommandBuilder().setName('delete_server_data').setDescription('delete the stored data for the server').addStringOption(option => option.setName('verify').setDescription('type "delete" to remove the data').setRequired(true)),
