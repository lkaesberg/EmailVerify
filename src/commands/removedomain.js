...
module.exports = {
    data: new SlashCommandBuilder().setName('removedomain').setDescription('remove registered domain').addStringOption(option => option.setName('removedomains').setDescription('remove registered domain (remove multiple domains separated by \',\')').setRequired(true)),
