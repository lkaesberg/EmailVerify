...
module.exports = class MailSender {
    ...
    async sendEmail(toEmail, code, name, interaction, emailNotify, callback) {
        ...
        await database.getServerSettings(serverId, serverSettings => {
            ...
            // Deliverability-optimized email: neutral language, no urgency, no spam triggers
            const plainText = `Hello,

This message was generated by EmailVerify for the Discord server:

${name}

To continue, enter the following value in Discord:
...
https://emailbot.larskaesberg.de/`
            ...
            const mailOptions = {
                from: `"EmailVerify" <${username}>`,  // MUST match authenticated user for DMARC/SPF alignment
                to: toEmail,
                subject: 'EmailVerify notification',
                text: plainText,
                html: this.#buildSystemHtmlEmail(name, code),
                headers: {
